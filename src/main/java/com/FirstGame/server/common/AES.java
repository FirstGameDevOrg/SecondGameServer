...
public class AES {
    ...
    private static final String pwd = "firstgame.^(2023";

    public String encrypt(String data){
        return encode(data,pwd);
    }

    public String decrypt(String data){
        return decode(data,pwd);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("after:" + encodeResultStr);
        // 解密
        String decodeResultStr = aes.decode(encodeResultStr,pwd);
        System.out.println("result:" + decodeResultStr);
    }
